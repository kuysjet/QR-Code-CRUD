  ...
  <div class="container">
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
        ...
        ?>
        <div class="form-wrap border rounded p-4 shadow">
          <h1 class="gradient text-center">Log In</h1>
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <p class="mb-0 text-center">Don't have an account ? <a href="./register.php">Sign Up</a></p>
          </form>
          <!-- form ends here -->
        </div>
      </div>
